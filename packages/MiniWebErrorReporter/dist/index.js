(function (global, factory) {
  ...
  let ErrorReporter = /*#__PURE__*/function () {
    ...
    _createClass(ErrorReporter, [{
      ...
      key: "processByRandom",
      value: function processByRandom(queue) {
      ...
      key: "processByFilterIgore",
      value: function processByFilterIgore(queue) {
        const {
          ignoreErrors
        } = this.config;
      ...
      key: "processMergeBreadcrumbs",
      value: function processMergeBreadcrumbs(log) {
        const retLog = log;
      ...
      value: function gLog(log) {
        ...
        return _asyncToGenerator(function* () {
          ...
          return _objectSpread2$1(_objectSpread2$1({}, metaData), {}, {
            appVersion,
            env,
            logs: log
          });
      ...
      key: "wrapFnArgs",
      value: function wrapFnArgs(args = []) {
        return args.map(arg => {
          if (isFunction(arg)) {
  ...
  let Reportor = /*#__PURE__*/function (_ErrorReporter) {
    _inherits(Reportor, _ErrorReporter);
    ...
    function Reportor(opts = {}) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(Reportor).call(this, opts)); // 合并参数
